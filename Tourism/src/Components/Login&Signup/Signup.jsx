...
export default function Signup() {
    ...
    const handleGoogleSignup = async () => {
        try {
            ...
            if (!userDoc.exists()) {
                // If user doesn't exist, save their details to Firestore
                await setDoc(doc(db, 'users', user.uid), {
                    fullname: user.displayName, // Use display name from Google
                    email: user.email,
                });
            }
            navigate('/Home');
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                ...
                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                    ...
                                    <path fill="#1565c0" d="M43.611,20.083L43.595,20L42,20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C39.118,37.094,43.611,29.543,43.611,20.083z"></path>
                                </svg>
                            </button>
                        </div>
                    </div>
